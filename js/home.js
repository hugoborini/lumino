...
function addHTML(movie, modal) {
  ...
  modal.style.background = "0% 25% / cover url(assets/mini/" + mini + ")";
  modal.innerHTML =
    '<div class="modal__icons"><div class="modal__icons--left"><img src="assets/icon/add.svg" class="modal__icon" /><img src="assets/icon/like.svg" class="modal__icon" /></div><div class="modal__icons--right"><img src="assets/icon/like.svg" class="modal__icon butt" /></div></div><img src="assets/icon/big_play.svg" class="modal__icon--play" /><div class="modal__texts"><h1 class="modal__title">' +
    title +
