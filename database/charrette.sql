...
(2, 'Avengers : Infinity Wars', 'The Avengers and their allies must be willing to sacrifice all in an attempt to defeat the powerful Thanos before his blitz of devastation and ruin puts an end to the universe.', 'Action', 'assets/video/avengers.mp4', 'assets/mini/avengers.jpg', 0, '2018-01-01'),
