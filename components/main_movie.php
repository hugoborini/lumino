<section class="main__movie">
    <div class="category__main">
      ...
      <div class="category__info info">
        ...
        <div class="info__released item__hero"><strong>NEW</strong> <span>2019</span> <img class="info__list" src="./assets/icon/Add.svg" alt="add to my list" /> <img class="info__like" src="./assets/icon/like.svg" alt="like" /> </div>
